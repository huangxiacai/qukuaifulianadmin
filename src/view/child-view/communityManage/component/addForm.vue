  ...
  <div>
    <Form :ref="refName" :model="formModel" :rules="formRules" :label-width="80">
      <FormItem label="小区名称" prop="name">
        <Input v-model="formModel.name" placeholder="请填写小区名称">
        </Input>
      </FormItem>
      <FormItem label="小区地址" prop="address">
        <Input v-model="formModel.address" placeholder="请填写小区地址">
        </Input>
      </FormItem>
        ...
        <!--<div class="demo-upload-list" v-for="item in formModel.uploadQualifyList">-->
          <!--<template v-if="item.status === 'finished'">-->
            ...
            <!--<div class="demo-upload-list-cover">-->
              ...
              <!--<Icon type="ios-trash-outline" @click.native="handleRemove(item,qualifyRef)"></Icon>-->
            <!--</div>-->
          <!--</template>-->
          <!--<template v-else>-->
      ...
      <!--<FormItem label="上传合同" prop="uploadContractList">-->
        <!--<div class="demo-upload-list" v-for="item in formModel.uploadContractList">-->
          <!--<template v-if="item.status === 'finished'">-->
            ...
            <!--<div class="demo-upload-list-cover">-->
              <!--<Icon type="ios-eye-outline" @click.native="handleView(item.name)"></Icon>-->
              <!--<Icon type="ios-trash-outline" @click.native="handleRemove(item,contractRef)"></Icon>-->
            <!--</div>-->
          <!--</template>-->
          <!--<template v-else>-->
            <!--<Progress v-if="item.showProgress" :percent="item.percentage" hide-info></Progress>-->
